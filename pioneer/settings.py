...
SECRET_KEY = '1!5+8!1d#+815tcx76ad_u)6omlmd9w-)^sp^alig4%2w$0l^j'
...
MIDDLEWARE = [
    ...
    'django.contrib.sessions.middleware.SessionMiddleware', #Manager sessions across qeruests
...
MEDIA_URL = '/files/'
MEDIA_DIRS = [os.path.join(BASE_DIR, 'files')]
